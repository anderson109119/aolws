...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo2 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao2', 'enviateste2.xml')) 
...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo3 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao3', 'enviateste3.xml'))
...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo4 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao4', 'enviateste4.xml'))
...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo5 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao5', 'enviateste5.xml'))
...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo6 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao6', 'enviateste6.xml')) 
...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo7 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao7', 'enviateste7.json')) 
...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo8 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao8', 'enviateste8.json'))  
...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo9 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao9', 'enviateste9.xml'))
...
# Abre o arquivo .xml que será enviado e grava as informações da string acima dentro dele
	arquivo10 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao10', 'enviateste10.xml'))
...
def sobrescreve_envio_xml10
		...
		arquivoenvio10 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao10', 'enviatesteincluirexame.xml')) 
...
def sobrescreve_envio_xml11
		...
		arquivoenvio11 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao11', 'enviatesteincluirpaternidade.xml')) 
...
def envio_xml_resultado_exame
		...
		arquivoenvio12 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao12', 'enviatesteresultadoexame.xml')) 
...
def envio_xml_duplo_COAG4
		...
		arquivoenvio13 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao13', 'enviatesteretornaduploCOAG4.xml'))
...
def envio_xml_duplo_clear
		...
		arquivoenvio14 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao14', 'enviatesteretornaduploclear.xml')) 
...
def envio_xml_dados_adicionais_diferentes
		...
		arquivoenvio15 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao15', 'enviatesteretornoexameadddiferentes.xml'))
...
def envio_xml_dados_exames_amostras_diferentes
		...
		arquivoenvio16 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao16', 'enviatesteretornoexameamostrasiguais.xml'))
...
def envio_xml_dados_exames_solicitacao_exame
		...
		arquivoenvio17 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao17', 'enviatesteretornoinclusaoexame.xml'))
	...
	def envio_xml_dados_exames_inclusao_nova_amostra
		...
		arquivoenvio18 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao18', 'enviatesteretornoinclusaoexamenovaamostra.xml'))
	...
	def envio_xml_dados_consulta_exames
		...
		arquivoenvio19 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao19', 'enviatesteretornoconsultaexame.xml'))
	...
	def envio_xml_dados_exclusao_exames
		...
		arquivoenvio20 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao20', 'enviatesteretornoexclusaoexame.xml'))
	...
	def envio_xml_dados_solicitacao_cadastrada
		...
		arquivoenvio21 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao21', 'enviatesteretornosolicitacaocadastrada.xml'))
	...
	def envio_xml_dados_novo_idsequencial
		...
		arquivoenvio22 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao22', 'enviatesteretornosolicitacaodadosok.xml')) 
	...
	def envio_xml_dados_idsequencial_solicitacao_cadastrados
		...
		arquivoenvio23 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao23', 'enviatesteretornosolicitaidseqcadastrados.xml'))
	...
	def envio_xml_dados_incluir_diversos_exames
		...
		arquivoenvio24a = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'enviatesteretornoincluiconsultaexcluidiversos.xml')) 
	...
	<solicitacao idAlvaro="300350271">
		...
		arquivoenvio24b = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'enviatesteretornoconsultadiversos.xml')) 
    ...
    <exame codigoExame="CLEAR1"/>
		...
		arquivoenvio24c = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'enviatesteretornoexcluirdiversos.xml'))
    ...
    <exame codigo=""/>
		...
		arquivoenvio25 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao25', 'enviatesteidalvaroretornosolicitacod.xml')) 
    ...
    <exame codigo=""/>
		...
		arquivoenvio26 = File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao26', 'enviatestetagresultado.xml')) 
...
# com o mesmo valor.
	def enviar_solicitacao
		...
		arquivo_b = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao', 'enviateste.xml'))
		$filtrar_dado = arquivo_b.gsub("substituir",$datatime1)
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao', 'enviateste.xml'), "w") do |f|
	  	f.write($filtrar_dado)

			File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao', 'historico_envio.txt'), "a") do |g|
			g.puts($filtrar_dado)
			f.close
			g.close
	  	 	end
	...
	def enviar_solicitacao2
		...
		arquivo_c = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao2', 'enviateste2.xml')) 
		...
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao2', 'enviateste2.xml'), "w") do |j|
	  	j.write($filtrar_dado2)
		# Guarda o que foi enviado no arquivo de histórico
			File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao2', 'historico_envio2.txt'), "a") do |i|
	...
	def enviar_solicitacao3
		...
		arquivo_d = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao3', 'enviateste3.xml'))
			
		$filtrar_dado3 = arquivo_d.gsub("substituir3", $datatime3)
		$filtrar_dado4 = $filtrar_dado3.gsub("Leucocitos=300", "")			
			
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao3', 'enviateste3.xml'), "w") do |l|
		l.write($filtrar_dado4)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao3', 'historico_envio3.txt'), "a") do |m|
	...
	def enviar_solicitacao4
		...
		arquivo_e = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao4', 'enviateste4.xml'))
		
		$filtrar_dado5 = arquivo_e.gsub("substituir4", $datatime4)
		$filtrar_dado6 = $filtrar_dado5.gsub("Leucocitos=300", "a=b")			
			
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao4', 'enviateste4.xml'), "w") do |n|
	  	n.write($filtrar_dado6)	  		

			File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao4', 'historico_envio4.xml'), "a") do |o|
	...
	def enviar_solicitacao5
		...
		arquivo_f = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao5', 'enviateste5.xml')) 
			
		$filtrar_dado7 = arquivo_f.gsub("substituir5", $datatime5)
		$filtrar_dado8 = $filtrar_dado7.gsub('dadosadicionais="Leucocitos=300"', "")			
			
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao5', 'enviateste5.xml'), "w") do |q|
		q.write($filtrar_dado8)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao5', 'enviateste5.xml'), "a") do |r|
	...
	def enviar_solicitacao6
		...
		arquivo_x = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao6', 'enviateste6.xml'))
			
		$filtrar_dado9 = arquivo_x.gsub("substituir6", $datatime6)			
			
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao6', 'enviateste6.xml'), "w") do |s|
	  	s.write($filtrar_dado9)	  		

		  	File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao6', 'historico_envio6.txt'), "a") do |t|
	...
	def enviar_solicitacao6_JSON_removeamostra
		...
		arquivo_v = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao8', 'enviateste8.json')) 
		...
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao8', 'enviateste8.json'), "w") do |x|
		x.write($filtrar_dado12)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao8', 'historico_envio8.txt'), "a") do |z|
	...
	def enviar_solicitacao9
		...
		arquivo_aa = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao9', 'enviateste9.xml')) 
			
		$filtrar_dado13 = arquivo_aa.gsub("substituir9", $datatime7)			
			
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao9', 'enviateste9.xml'), "w") do |z|
		z.write($filtrar_dado13)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao9', 'historico_envio9.txt'), "a") do |u|
	...
	def enviar_solicitacao10
		...
		arquivo_bb = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao10', 'enviatesteincluirexame.xml')) 
		...
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao10', 'enviatesteincluirexame.xml'), "w") do |o|
	  	o.write($filtrar_dado13)	  		

			File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao10', 'historico_envioexame.txt'), "a") do |i|
	...
	def enviar_solicitacao11
		...
		$datatime9 = "#{Time.now.strftime('%Y%m%d%H%M%S%L')}"
			...
			# Lê o incliexame já preenchido pelo xml		
		arquivo_xx = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao11', 'enviatesteincluirpaternidade.xml')) 
			# substitui pelo codigo lis
		$filtrar_dado15 = arquivo_xx.gsub("substituirenvio11", $datatime9)			
			# escreve a nova atualização no arquivo enviatesteincluirexame
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao11', 'enviatesteincluirpaternidade.xml'), "w") do |l|
		l.write($filtrar_dado15)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao11', 'historico_envioexamepaternidade.txt'), "a") do |m|
	...
	def enviar_solicitacao12
		...
		$arquivo_xyz = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao12', 'enviatesteresultadoexame.xml'))	  		

	  	File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao12', 'historico_resultadoexame.txt'), "a") do |m|
	  	m.puts($arquivo_xyz)
	  	m.close  			
		end
	end
	...
	def enviar_solicitacao13
		...
		$datatime10 = "#{Time.now.strftime('%Y%m%d%H%M%S%L')}"
			...
			# Lê o incliexame já preenchido pelo xml		
		$arquivo_aaa = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao13', 'enviatesteretornaduploCOAG4.xml'))
			# substitui pelo codigo lis
		$filtrar_dado16 = $arquivo_aaa.gsub("substituirenvio13", $datatime10)			
			# escreve a nova atualização no arquivo enviatesteincluirexame
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao13', 'enviatesteretornaduploCOAG4.xml'), "w") do |b|
		b.write($filtrar_dado16)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao13', 'historico_duploCOAG4.txt'), "a") do |g|
	...
	def enviar_solicitacao14
		...
		$datatime11 = "#{Time.now.strftime('%Y%m%d%H%M%S%L')}"
			...
			# Lê o incliexame já preenchido pelo xml		
		$arquivo_aab = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao14', 'enviatesteretornaduploclear.xml')) 
			# substitui pelo codigo lis
		$filtrar_dado17 = $arquivo_aab.gsub("substituirenvio14", $datatime11)			
			# escreve a nova atualização no arquivo enviatesteincluirexame
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao14', 'enviatesteretornaduploclear.xml'), "w") do |h|
		h.write($filtrar_dado17)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao14', 'historico_duploclear.txt'), "a") do |i|
	...
	def enviar_solicitacao15
		...
		$datatime12 = "#{Time.now.strftime('%Y%m%d%H%M%S%L')}"
			...
			# Lê o incliexame já preenchido pelo xml		
		$arquivo_aac = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao15', 'enviatesteretornoexameadddiferentes.xml'))
			# substitui pelo codigo lis
		$filtrar_dado18 = $arquivo_aac.gsub("substituirenvio15", $datatime12)			
			# escreve a nova atualização no arquivo enviatesteincluirexame
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao15', 'enviatesteretornoexameadddiferentes.xml'), "w") do |i|
		i.write($filtrar_dado18)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao15', 'historico_dadoadddistintos.txt'), "a") do |l|
	...
	def enviar_solicitacao16
		...
		$datatime13 = "#{Time.now.strftime('%Y%m%d%H%M%S%L')}"
			...
			# Lê o incliexame já preenchido pelo xml		
		$arquivo_aad = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao16', 'enviatesteretornoexameamostrasiguais.xml')) 
			# substitui pelo codigo lis
		$filtrar_dado19 = $arquivo_aad.gsub("substituirenvio16", $datatime13)			
			# escreve a nova atualização no arquivo enviatesteincluirexame
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao16', 'enviatesteretornoexameamostrasiguais.xml'), "w") do |j|
		j.write($filtrar_dado19)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao16', 'historico_examesamostrasiguais.txt'), "a") do |r|
	...
	def enviar_solicitacao17
		...
		$datatime14 = "#{Time.now.strftime('%Y%m%d%H%M%S%L')}"
			...
			# Lê o incliexame já preenchido pelo xml		
		$arquivo_aae = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao17', 'enviatesteretornoinclusaoexame.xml'))
			# substitui pelo codigo lis
		$filtrar_dado20 = $arquivo_aae.gsub("substituirenvio17", $datatime14)			
			# escreve a nova atualização no arquivo enviatesteincluirexame
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao17', 'enviatesteretornoinclusaoexame.xml'), "w") do |v|
		v.write($filtrar_dado20)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao17', 'historico_inclusaoexame.txt'), "a") do |u|
	...
	def enviar_solicitacao18
		...
		$datatime15 = "#{Time.now.strftime('%Y%m%d%H%M%S%L')}"
			...
			# Lê o incliexame já preenchido pelo xml		
		$arquivo_aaf = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao18', 'enviatesteretornoinclusaoexamenovaamostra.xml'))
			# substitui pelo codigo lis
		$filtrar_dado21 = $arquivo_aaf.gsub("substituirenvio18", "CITRA")			
			# escreve a nova atualização no arquivo enviatesteincluirexame
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao18', 'enviatesteretornoinclusaoexamenovaamostra.xml'), "w") do |t|
		t.write($filtrar_dado21)
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao18', 'historico_inclusaoexamenovaamostra.txt'), "a") do |w|
	...
	def enviar_solicitacao19
		...
		$arquivo_aag = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao19', 'enviatesteretornoconsultaexame.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao19', 'historico_consultaexame.txt'), "a") do |f|
	  		f.puts($arquivo_aag)
	  		f.close
		end
	end
	...
	def enviar_solicitacao20
		...
		$arquivo_aah = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao20', 'enviatesteretornoexclusaoexame.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao20', 'historico_excluirexame.txt'), "a") do |j|
	  		j.puts($arquivo_aah)
	  		j.close
		end
	end
	...
	def enviar_solicitacao21
		...
		$arquivo_aai = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao21', 'enviatesteretornosolicitacaocadastrada.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao21', 'historico_solicitacaocadastrada.txt'), "a") do |x|
	  		x.puts($arquivo_aai)
	  		x.close
		end
	end
	...
	def enviar_solicitacao22
		...
		$datatime22 = "#{Time.now.strftime('%Y%m%d%H%M%S%L')}"
			...
			# Lê o incliexame já preenchido pelo xml		
		$arquivo_aaj = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao22', 'enviatesteretornosolicitacaodadosok.xml')) 
			# substitui pelo id sequencial
		$filtrar_dado22 = $arquivo_aaj.gsub("substituiridsequencial", $datatime22)			
			# escreve a nova atualização no arquivo enviatesteincluirexame
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao22', 'enviatesteretornosolicitacaodadosok.xml'), "w") do |y|
		y.write($filtrar_dado22)
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao22', 'historico_solicitacaodadosok.txt'), "a") do |s|
	...
	def enviar_solicitacao23
		...
		$arquivo_aag = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao23', 'enviatesteretornosolicitaidseqcadastrados.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao23', 'historico_solicitacaoidseqcadastrados.txt'), "a") do |r|
	  		r.puts($arquivo_aag)
	  		r.close
		end
	end
	...
	def enviar_solicitacao24a
		...
		$arquivo_aah = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'enviatesteretornoincluiconsultaexcluidiversos.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'historico_enviatesteretornoincluiconsultaexcluidiversos.txt'), "a") do |v|
	  		v.puts($arquivo_aah)
	  		v.close
		end
	end
	...
	def enviar_solicitacao24b
		...
		$arquivo_aai = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'enviatesteretornoconsultadiversos.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'historico_enviatesteretornoconsultadiversos.txt'), "a") do |y|
	  		y.puts($arquivo_aai)
	  		y.close
		end
	end
	...
	def enviar_solicitacao24c
		...
		$arquivo_aaj = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'enviatesteretornoexcluirdiversos.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao24', 'historico_enviatesteretornoexcluirdiversos.txt'), "a") do |z|
	  		z.puts($arquivo_aaj)
	  		z.close
		end
	end
	...
	def enviar_solicitacao25
		...
		$arquivo_aal = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao25', 'enviatesteidalvaroretornosolicitacod.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao25', 'historico_enviatesteidalvaroretornosolicitacod.txt'), "a") do |r|
	  		r.puts($arquivo_aal)
	  		r.close
		end
	end
	...
	def enviar_solicitacao26
		...
		$arquivo_aam = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao26', 'enviatestetagresultado.xml'))
		  	
	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao26', 'historico_enviatestetagresultado.txt'), "a") do |f|
	  		f.puts($arquivo_aam)
	  		f.close
		end
	end
	...
	def removeexame
		...
		arquivo_b = File.read(File.join(Dir.pwd, 'features', 'xml', 'solicitacao10', 'enviateste10.xml')) 
		...
		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao10', 'enviateste10.xml'), "w") do |b|
		b.write($filtrar_dado14)	  		

	  		File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao10', 'historico_envio10.txt'), "a") do |c|
	...
	def enviar_solicitacao53
  	...
  	def validar_amostras
		...
		enviocodigo = Nokogiri::XML(File.open(File.join(Dir.pwd, 'features', 'xml', 'solicitacao', 'enviateste.xml')))
